...
// DESC: The main dashboard for solvers, with cards now linking to the detail page.
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {mockChallenges.map(c => (
                <Link href={`/challenges/${c.id}`} key={c.id}>
                    <div className="bg-white dark:bg-gray-800/70 border border-gray-200 dark:border-gray-700 rounded-xl p-6 h-full hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer flex flex-col">
                        <div>
